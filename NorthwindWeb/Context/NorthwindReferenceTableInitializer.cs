...
namespace NorthwindWeb.Context
{
    ...
    public static class NorthwindReferencedTableInitializer
    {
        ...
        public static void InsertNorthwindReferencedData(NorthwindDatabase context)
        {
            ...
            context.Categories.Add(new Categories() { CategoryName = "Classical", Description = "Button phones" });
            context.SaveChanges();
            context.Categories.Add(new Categories() { CategoryName = "Smartphone", Description = "Touch screen" });
            context.SaveChanges();
            context.Categories.Add(new Categories() { CategoryName = "Accessory", Description = "Selfie sticks, Chargers, Headphones, Batteries, Covers" });
            context.SaveChanges();
            context.Categories.Add(new Categories() { CategoryName = "Gadgets", Description = "Speakers, VR Glasses, Remote Controls" });
            context.SaveChanges();
            context.Categories.Add(new Categories() { CategoryName = "eBook Reader", Description = "Bookreader" });
            context.SaveChanges();
            context.Categories.Add(new Categories() { CategoryName = "Services", Description = "Services offered" });
            context.SaveChanges();
            ...
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Stereo Hat with Black Microphone", SupplierID = 1, CategoryID = 4, QuantityPerUnit = "1", UnitPrice = (decimal?)37.00, UnitsInStock = 6, UnitsOnOrder = 10, ReorderLevel = 15, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Seeker location device", SupplierID = 1, CategoryID = 4, QuantityPerUnit = "1", UnitPrice = (decimal?)29.00, UnitsInStock = 26, UnitsOnOrder = 0, ReorderLevel = 15, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Media-Tech remote control for VR", SupplierID = 1, CategoryID = 4, QuantityPerUnit = "1", UnitPrice = (decimal?)39.00, UnitsInStock = 15, UnitsOnOrder = 10, ReorderLevel = 30, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Drone Arcade Orbit", SupplierID = 1, CategoryID = 4, QuantityPerUnit = "1", UnitPrice = (decimal?)149.00, UnitsInStock = 26, UnitsOnOrder = 0, ReorderLevel = 0, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "OnReal Black Background Video Camera", SupplierID = 1, CategoryID = 4, QuantityPerUnit = "1", UnitPrice = (decimal?)514.00, UnitsInStock = 14, UnitsOnOrder = 0, ReorderLevel = 0, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Bluetooth Arcade Remote", SupplierID = 1, CategoryID = 4, QuantityPerUnit = "1", UnitPrice = (decimal?)74.00, UnitsInStock = 101, UnitsOnOrder = 0, ReorderLevel = 5, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Ubtech Alpha Interactive Intelligent Robot", SupplierID = 1, CategoryID = 4, QuantityPerUnit = "1", UnitPrice = (decimal?)2369.00, UnitsInStock = 4, UnitsOnOrder = 20, ReorderLevel = 5, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Intelligent Service Robot Uno", SupplierID = 1, CategoryID = 4, QuantityPerUnit = "1", UnitPrice = (decimal?)3249.00, UnitsInStock = 125, UnitsOnOrder = 0, ReorderLevel = 25, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Portable Flip 4 Waterproof Black Box", SupplierID = 1, CategoryID = 4, QuantityPerUnit = "1", UnitPrice = (decimal?)579.00, UnitsInStock = 57, UnitsOnOrder = 0, ReorderLevel = 20, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Wireless Portable Speaker With Microphone", SupplierID = 1, CategoryID = 4, QuantityPerUnit = "1", UnitPrice = (decimal?)499.00, UnitsInStock = 32, UnitsOnOrder = 0, ReorderLevel = 15, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Diagnostics", SupplierID = 1, CategoryID = 6, QuantityPerUnit = "1", UnitPrice = (decimal?)60.00, UnitsInStock = 0, UnitsOnOrder = 10, ReorderLevel = 1, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Battery replacement", SupplierID = 1, CategoryID = 6, QuantityPerUnit = "1", UnitPrice = (decimal?)120.00, UnitsInStock = 0, UnitsOnOrder = 9, ReorderLevel = 1, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Screen replacement", SupplierID = 1, CategoryID = 6, QuantityPerUnit = "1", UnitPrice = (decimal?)400.00, UnitsInStock = 0, UnitsOnOrder = 9, ReorderLevel = 1, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Protective foil replacement", SupplierID = 1, CategoryID = 6, QuantityPerUnit = "1", UnitPrice = (decimal?)70.00, UnitsInStock = 0, UnitsOnOrder = 9, ReorderLevel = 1, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Motherboard replacement", SupplierID = 1, CategoryID = 6, QuantityPerUnit = "1", UnitPrice = (decimal?)900.00, UnitsInStock = 0, UnitsOnOrder = 9, ReorderLevel = 1, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Android installation", SupplierID = 1, CategoryID = 6, QuantityPerUnit = "1", UnitPrice = (decimal?)80.00, UnitsInStock = 0, UnitsOnOrder = 9, ReorderLevel = 1, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "IOS installation", SupplierID = 1, CategoryID = 6, QuantityPerUnit = "1", UnitPrice = (decimal?)120.00, UnitsInStock = 0, UnitsOnOrder = 9, ReorderLevel = 1, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Install windows phone", SupplierID = 1, CategoryID = 6, QuantityPerUnit = "1", UnitPrice = (decimal?)80.00, UnitsInStock = 0, UnitsOnOrder = 9, ReorderLevel = 1, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Windows phone data recovery", SupplierID = 1, CategoryID = 6, QuantityPerUnit = "1", UnitPrice = (decimal?)140.00, UnitsInStock = 0, UnitsOnOrder = 9, ReorderLevel = 1, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "Android data recovery", SupplierID = 1, CategoryID = 6, QuantityPerUnit = "1", UnitPrice = (decimal?)120.00, UnitsInStock = 0, UnitsOnOrder = 9, ReorderLevel = 1, Discontinued = false });
            context.SaveChanges();
            context.Products.Add(new Products() { ProductName = "IOS data recovery", SupplierID = 1, CategoryID = 6, QuantityPerUnit = "1", UnitPrice = (decimal?)160.00, UnitsInStock = 0, UnitsOnOrder = 9, ReorderLevel = 1, Discontinued = false });
            context.SaveChanges();
