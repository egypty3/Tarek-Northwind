    ...
    $('#RolesTable').DataTable({
        ...
        "ajax": {
            ...
            "dataSrc": function (json) {
                //Make your callback here.
                $.each(json.data, function (index, item) {
                    item.Delete = '<a href= "' + searchControllerPath() + '/RoleDelete?roleName=' + item.Name + '" onclick="if (!confirm(' + "'Are you sure u want to delete ?'" + ')) return false;"/> <i class="fa fa-remove"></i></a >';
                    item.Membership = '<a href= "' + searchControllerPath() + '/RoleMembership?roleName=' + item.Name + '&name=' + item.Name + '"/>Members</a >';
                });
    ...
    $('#UsersInRole').DataTable({
        ...
        "ajax": {
            ...
            "dataSrc": function (json) {
                //Make your callback here.
                $.each(json.data, function (index, item) {
                    item.Delete = '<a href= "' + searchControllerPath() + '/DeleteFromRole?userName=' + item.UserName + '&roleName=' + json.roleName + '" onclick="if (!confirm(' + "'Are you sure u want to delete ?'" + ')) return false;"/> <i class="fa fa-remove"></i></a >';
